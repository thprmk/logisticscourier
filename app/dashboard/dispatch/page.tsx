      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white rounded-lg border border-blue-200 p-6 hover:shadow-lg transition-shadow">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold text-blue-700 uppercase tracking-wide">Incoming Manifests</p>
              <p className="text-3xl font-bold text-blue-900 mt-2">{incomingManifests.length}</p>
            </div>
        ...
        <div className="bg-white rounded-lg border border-green-200 p-6 hover:shadow-lg transition-shadow">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold text-green-700 uppercase tracking-wide">Outgoing Manifests</p>
              <p className="text-3xl font-bold text-green-900 mt-2">{outgoingManifests.length}</p>
            </div>
        ...
        <div className="bg-white rounded-lg border border-orange-200 p-6 hover:shadow-lg transition-shadow">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold text-orange-700 uppercase tracking-wide">Available for Dispatch</p>
              <p className="text-3xl font-bold text-orange-900 mt-2">{availableShipments.length}</p>
            </div>
