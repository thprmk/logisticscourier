      ...
      <div className="relative min-h-screen flex items-center justify-center px-3 sm:px-4 py-6 sm:py-8 lg:py-12">
        <div className="w-full max-w-[25rem] sm:max-w-md bg-white/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-5 sm:p-7 md:p-9 shadow-2xl border border-gray-200/50 mx-auto">
              ...
              <div className="text-center mb-5 sm:mb-7">
                <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 mb-3 sm:mb-4">
                  <Package className="h-10 w-10 sm:h-10 sm:w-10 text-blue-600" strokeWidth={2} />
                </div>
              ...
              <Button
                type="submit"
                disabled={isLoading}
                  className="w-full h-11 sm:h-12 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-semibold rounded-lg sm:rounded-xl transition-all duration-200 shadow-md hover:shadow-lg disabled:opacity-75 disabled:cursor-not-allowed mt-2 text-sm sm:text-base touch-manipulation"
              >
                {isLoading ? (
